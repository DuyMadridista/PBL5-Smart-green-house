import { defineComponent, h, getCurrentInstance, effectScope, inject, onMounted, onUnmounted, shallowRef, ref, computed, onBeforeMount, watch, Fragment, isRef, createVNode, Text } from 'vue';
...
function createCompileError(code, loc, options = {}) {
    ...
    const msg = (process.env.NODE_ENV !== 'production')
        ? format$1((messages || errorMessages$2)[code] || '', ...(args || []))
        : code;
