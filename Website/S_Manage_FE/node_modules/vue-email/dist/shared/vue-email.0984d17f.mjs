...
function cleanCss(css) {
  ...
  const newCss = css.replace(/\\/g, "").replace(SELETORS_REGEX, (m) => {
...
function getMediaQueryCss(css) {
  ...
  return css.replace(mediaQueryRegex, (m) => {
...
const ETailwind = defineComponent({
  ...
  async setup(props, { slots }) {
    ...
    const fullHTML = await renderToString(h("div", $default)).then((html2) => html2.replace(/^<div[^>]*>|<\/div>$/g, ""));
...
export { EMarkdown as A, BinTrieFlags as B, deepmerge as C, DomHandler as D, EBody as E, components as F, VueEmailPlugin as V, render as a, convertStyleStringToObj as b, cleanup as c, determineBranch as d, EButton as e, fromCodePoint as f, EColumn as g, htmlDecodeTree as h, isTag as i, EContainer as j, EFont as k, EHead as l, EHeading as m, EHr as n, EHtml as o, pxToPt as p, EImg as q, replaceCodePoint as r, ELink as s, EPreview as t, ERow as u, ESection as v, withMargin as w, xmlDecodeTree as x, ETailwind as y, EText as z };
